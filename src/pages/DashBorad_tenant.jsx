...
import AdminsView from '../components/dashboard_tenant/ViewAdmins'
import SidebarExtendedUs from '../components/dashboard_tenant/SidebarExtendedUs'
...
const DashboardTenant = () => {
	...
	const ActiveComponent = componentMap[activeSection] || AdminsView
	...
	return (
		<div className="dashboard-tenant">
			...
			<SidebarExtendedUs onOptionChange={setActiveSection} />

			{/* ------------------ render-section -------------- */}
			<div className="render-section pt-2 sm:ml-64">
				<ActiveComponent />
			</div>
		</div>
	)
